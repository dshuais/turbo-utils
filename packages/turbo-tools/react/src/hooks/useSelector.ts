/*
 * @Author: dushuai
 * @Date: 2024-08-06 21:58:37
 * @LastEditors: dushuai
 * @LastEditTime: 2024-08-10 16:40:24
 * @description: useSelector
 */
import { useRef } from 'react';
import { shallow } from 'zustand/shallow';
import { pick } from 'turboutils';
 ...
 * @returns 返回需要的state
 */
export default function useSelector<T extends object, K extends keyof T>(fields?: Many<K>): (state: T) => Pick<T, K> {
  type P = Pick<T, K>;
